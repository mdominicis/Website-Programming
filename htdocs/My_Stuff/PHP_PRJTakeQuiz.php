...
<form method=post action="PHP_PRJQuizResults.php">

<?php
echo "Please answer the following questions;<br>";
...
for($r=0;$r<$rowCount;$r++)
{
	...
	echo "<tr>";
		...
		{
		  echo "<td><input type=\"text\" class=\"blue\" name=\"answer[" .$row[0]. "]\"" ." size=\"30\">";
		}
	    }
	echo "</tr>";
...
echo "</table>";
echo "<P><input type=\"submit\" value=\"Submit Quiz\" name=\"sub\"></P>";
